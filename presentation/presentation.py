...
def main(args):
    ...
    pcm_df = pdtb_df[['Relation','Conn1_PCM',  'Conn2_PCM','ARG1_RawText_PCM', 'ARG2_RawText_PCM', 'FullRawText_PCM',  'Connective_RawText_PCM']]
    pcm_df.to_csv(args.pcm_output_file)
    en_df = pdtb_df[['Relation', 'Conn1',        'Conn2','Arg1_RawText', 'Arg2_RawText', 'FullRawText',  'Connective_RawText']]
